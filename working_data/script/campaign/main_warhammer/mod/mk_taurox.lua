...
function start()
  ...
  if cm:is_new_game() then
    ...
    -- Taurox...
    -- move to Chaos wastelands area, Chaos start position
    ...
    reposition_starting_lord_for_faction(TAUROX_FACTION, TAUROX_FORENAME, TAUROX_FORENAME, 0, 0);
    local ghorros_is_chosen_lord = reposition_starting_lord_for_faction(TAUROX_FACTION, TAUROX_FORENAME, "names_name_2147357951", -7, 6); -- second army
...
function mk_taurox_ll_setup()
  ...
  if cm:is_new_game() then
    log('Locking regular beastmen LL lords at the start of the game');
    -- Khazrak
