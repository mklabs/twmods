...
local TAUROX_FORENAME = require('unlocker/constants').TAUROX_FORENAME;
local GHORROS_FORENAME = require('unlocker/constants').GHORROS_FORENAME;
...
local function ll_beastmen(ll_unlock)
  return {
    ...
    -- Taurox
    -- TODO: Cannot work due to not being able to setup Taurox in
    -- startpos_characters. The second param is the startpos_id.
    -- ll_unlock:new(
    --   TAUROX_FACTION,
    --   '1403603105',
